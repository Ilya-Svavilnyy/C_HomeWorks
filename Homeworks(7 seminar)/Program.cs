...
double[,] CreateRandomDouble2dArray()
{
    ...
    Console.Write("Input minValue of elements: ");
    int minValue = Convert.ToInt32(Console.ReadLine());
    Console.Write("Input maxValue of elements: ");
...
int ShowElement(int[,] array, int m, int n)
{
    ...
    {
        element = array[m,n];
        Console.WriteLine("Value of element: " + element);
    }
    else Console.WriteLine("Not find possible index of elements");
    return element;
}
...
Console.WriteLine("Average numbers on every columns: ");
ShowArray(myAverage);
*/